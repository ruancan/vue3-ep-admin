<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent" src="../assets/404.jpg" alt="404">
      ...
      <div class="bullshit">
        ...
        <!--createWebHistory模式下需要带路径                <a href="/home" class="bullshit__return-home">Back to home</a>-->
...
const message = ref('some one said that you can not enter this page...')
</script>
